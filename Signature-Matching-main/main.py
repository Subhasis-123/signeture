...
def checkSimilarity(window, path1, path2):
    ...
    if(result <= THRESHOLD):
        messagebox.showerror("Failure: Signatures Do Not Match","Signatures are "+str(result)+f" %similar!!try again")
        pass
    else:
...
img1_browse_button.place(x=400, y=123)
